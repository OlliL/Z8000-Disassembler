...
{0x2210,0x22ff, 1,1, 11, OPCALL(Z22_ddN0_imm4_segmented),		 "resb    @%rl3,#%3"},
{0x2300,0x230f, 1,2, 10, OPCALL(Z23_0000_ssss_0000_dddd_0000_0000),	 "res     %rw5,%rw3"},
{0x2310,0x23ff, 1,1, 11, OPCALL(Z23_ddN0_imm4_segmented),		 "res     @%rl3,#%3"},
{0x2400,0x240f, 1,2, 10, OPCALL(Z24_0000_ssss_0000_dddd_0000_0000),	 "setb    %rb5,%rw3"},
{0x2410,0x24ff, 1,1, 11, OPCALL(Z24_ddN0_imm4_segmented),		 "setb    @%rl3,#%3"},
{0x2500,0x250f, 1,2, 10, OPCALL(Z25_0000_ssss_0000_dddd_0000_0000),	 "set     %rw5,%rw3"},
{0x2510,0x25ff, 1,1, 11, OPCALL(Z25_ddN0_imm4_segmented),		 "set     @%rl3,#%3"},
...
{0x2200,0x220f, 1,2, 10, OPCALL(Z22_0000_ssss_0000_dddd_0000_0000),	 "resb    %rb5,%rw3"},
{0x2210,0x22ff, 1,1, 11, OPCALL(Z22_ddN0_imm4),				 "resb    @%rw3,#%3"},
{0x2300,0x230f, 1,2, 10, OPCALL(Z23_0000_ssss_0000_dddd_0000_0000),	 "res     %rw5,%rw3"},
{0x2310,0x23ff, 1,1, 11, OPCALL(Z23_ddN0_imm4),				 "res     @%rw3,#%3"},
{0x2400,0x240f, 1,2, 10, OPCALL(Z24_0000_ssss_0000_dddd_0000_0000),	 "setb    %rb5,%rw3"},
{0x2410,0x24ff, 1,1, 11, OPCALL(Z24_ddN0_imm4),				 "setb    @%rw3,#%3"},
{0x2500,0x250f, 1,2, 10, OPCALL(Z25_0000_ssss_0000_dddd_0000_0000),	 "set     %rw5,%rw3"},
{0x2510,0x25ff, 1,1, 11, OPCALL(Z25_ddN0_imm4),				 "set     @%rw3,#%3"},
{0x2600,0x260f, 1,2, 10, OPCALL(Z26_0000_ssss_0000_dddd_0000_0000),	 "bitb    %rb5,%rw3"},
